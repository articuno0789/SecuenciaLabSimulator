...
public class Modulo6 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        IncializacionContractores("EntradaPlugAnaranjado8", "EntradaPlugAnaranjado9", false);
        ...
        plugAnaranjadosDict["EntradaPlugAnaranjado9"].GetComponent<Plugs>().relacionCerrada = false;
    ...
    void IncializacionContractores(string nPlug1, string nPlug2, bool cerrado)
    {
        ...
        {
            Debug.LogError(this.name + ", Error. IncializacionContractores(string nPlug1, string nPlug2, bool cerrado) - primerPlug o segundoPlug es nulo.");
        }
    }
    ...
    /*Comportamiento para timers on delay (Punta de flecha para arriba) (Retardo al energizar)
    significa que una vez que un timer ha recibido una señal de
    de encendido, su salida cambiará de estado después de un 
